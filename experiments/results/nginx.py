...
def load_json(s, n, t):
    data = json.loads(open('../nginx/data/%s/%d-%s.json' % (s, n, t)).read())['result']
    return data['rps']['mean'] / 1000, data['latency']['mean'], data['latency']['percentiles']['99']
...
colors = ["#35618f", "#5ac4f8", "#6c218e", "#0b522e"]
markers = ['o', 'X', 'D', 'v']
