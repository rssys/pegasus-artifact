...
#define SYSCALL_ULIBOS CALL 8(GS)

TEXT runtime·exit(SB),NOSPLIT,$0-4
	MOVL	code+0(FP), DI
	MOVL	$SYS_exit_group, CX
	XORL	AX, AX
	SYSCALL_ULIBOS
	RET
